...
dagname = "customer_golden_data_metric_rev"
dag = DAG(
    dagname,
...
def run(a,b):
    ...
    print("I'm going to sleep for " + round(sleep/60) + " minute")
    time.sleep(sleep)
    print("I woke up after " + round(sleep/60) + " minute")


execute = PythonOperator(
    task_id='execute',
    python_callable=run,
    op_kwargs={"a": 30, "b": 120},
)
